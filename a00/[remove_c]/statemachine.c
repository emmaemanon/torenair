...
void change_state(void) {
	switch (sys_state) {
		...
		break;
		case CHANGEDATE_Y3:
			sprintf((char*) lcd_buffer1, "Ubah Tanggal :\0");
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d A", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
		...
		case CHANGEDATE_Y2:
			...
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d B", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case CHANGEDATE_Y1:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d C", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case CHANGEDATE_Y0:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d D", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case CHANGEDATE_M1:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d E", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case CHANGEDATE_M0:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d F", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case CHANGEDATE_D1:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d G", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case CHANGEDATE_D0:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d%d%d - %d%d - %d%d H", input[0], input[1], input[2], input[3], input[4], input[5], input[6], input[7]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case CHANGETIME_h1:
			input[0] = 0; input[1] = 0; input[2] = 0; input[3] = 0;
			input[4] = 0; input[5] = 0;
			sprintf((char*) lcd_buffer1, "Ubah Waktu :\0");
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d A\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case CHANGETIME_h0:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d B\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case CHANGETIME_m1:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d C\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case CHANGETIME_m0:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d D\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case CHANGETIME_d1:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d E\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case CHANGETIME_d0:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d F\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case POST_CHANGETIME:
			// sprintf((char*) lcd_buffer1, "Ubah Tanggal : %d", count);
			sprintf((char*) lcd_buffer2, "%d%d - %d%d - %d%d ?\0", input[0], input[1], input[2], input[3], input[4], input[5]);
			if ((keynumber == KEY_krs) && (button_state == MAYBE_PUSH_STATE)) {
		...
		case PRE_WATERMAX_W3:
			...
			sprintf((char*) lcd_buffer2, "Air ke %d%d%d%d cm A", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case PRE_WATERMAX_W2:
			sprintf((char*) lcd_buffer2, "Air ke %d%d%d%d cm B", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case PRE_WATERMAX_W1:
			sprintf((char*) lcd_buffer2, "Air ke %d%d%d%d cm C", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case PRE_WATERMAX_W0:
			sprintf((char*) lcd_buffer2, "Air ke %d%d%d%d cm D", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
	...
	////////////////////////////////////////////////////////////////////
		case CHANGERATE_R3:
			...
			sprintf((char*) lcd_buffer2, "per %d%d%d%d detik A", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		break;
		case CHANGERATE_R2:
			sprintf((char*) lcd_buffer2, "per %d%d%d%d detik B", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		break;
		case CHANGERATE_R1:
			sprintf((char*) lcd_buffer2, "per %d%d%d%d detik C", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		break;
		case CHANGERATE_R0:
			sprintf((char*) lcd_buffer2, "per %d%d%d%d detik D", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
	...
	///////////////////////////////////////////////////////////////////////////
		case PRE_WATERCAL:
			...
			sprintf((char*) lcd_buffer2, "Air?\0");
			if ((keynumber == KEY_krs) && (button_state == MAYBE_PUSH_STATE)) {
		...
		case PRE_TANKHEIGHT_X3:
			...
			sprintf((char*) lcd_buffer2, "ke %d%d%d%d cm A\0", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case PRE_TANKHEIGHT_X2:
			sprintf((char*) lcd_buffer2, "ke %d%d%d%d cm B\0", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case PRE_TANKHEIGHT_X1:
			sprintf((char*) lcd_buffer2, "ke %d%d%d%d cm C\0", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
				count++;
		...
		case PRE_TANKHEIGHT_X0:
			sprintf((char*) lcd_buffer2, "ke %d%d%d%d cm D\0", input[0], input[1], input[2], input[3]);
			if ((keynumber < 10) && (button_state == MAYBE_PUSH_STATE)) {
				input[count] = keynumber;
		...
		case POST_TANKHEIGHT:
			sprintf((char*) lcd_buffer2, "ke %d%d%d%d cm ?\0", input[0], input[1], input[2], input[3]);
			if ((keynumber == KEY_krs) && (button_state == MAYBE_PUSH_STATE)) {
